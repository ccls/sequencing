...
#ifndef ALIGNMENTFULL_H
#define ALIGNMENTFULL_H
...
class AlignmentFull : public Alignment {
 public:
  ~AlignmentFull();
  ...
  */
  AlignmentFull(ScoredSeq * seqA, ScoredSeq* seqB, char orientation);

  AlignmentFull* copySeqReplace(ScoredSeq* seqA, ScoredSeq* seqB);
  void seqReplace(ScoredSeq* seqA, ScoredSeq* seqB);
  AlignmentFull* copyRcSeqA(ScoredSeq* newSeqA);
  ...
  // class-specific;
  // REQUIRES all alignments in the array have the same seqA as this
  ScoredSeq* multiCombine(long numAls, AlignmentFull** alArray);
