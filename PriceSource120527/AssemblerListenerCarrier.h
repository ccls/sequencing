...
/* this implementation carries other listeners so that 
 * files and stdout can exist simultaneously.
 */

#ifndef ASSEMBLERLISTENERCARRIER_H
#define ASSEMBLERLISTENERCARRIER_H
#include <string>
#include <fstream>
...
class AssemblerListenerCarrier : public AssemblerListener {

 public:

  AssemblerListenerCarrier();
  AssemblerListenerCarrier(AssemblerListener** listeners, int numListeners);
  ~AssemblerListenerCarrier();
