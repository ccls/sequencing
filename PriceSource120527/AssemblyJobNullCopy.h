 ...
 * a copy of the input should just be returned.
 */

#ifndef ASSEMBLYJOBNULLCOPY_H
#define ASSEMBLYJOBNULLCOPY_H
...
class AssemblyJobNullCopy: public AssemblyJob {

 public:
  AssemblyJobNullCopy();
  AssemblyJobNullCopy(set<ScoredSeq*>* seqs);
  ~AssemblyJobNullCopy();
