/* $Id: blast_engine.c 370872 2012-08-02 17:19:24Z rafanovi $
 * ===========================================================================
 *
...
NCBI_XBLAST_EXPORT const int   kBlastPatchVersion = 27;
NCBI_XBLAST_EXPORT const char* kBlastReleaseDate = "Aug-12-2012";
